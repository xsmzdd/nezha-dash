...
import { cn, getServerSortIndex, nezhaFetcher } from "@/lib/utils"
...
export function AggregatedNetworkCharts() {
  ...
  const onlineServers = useMemo(() => {
    ...
    return serverData.result
      ...
      .sort((a, b) => {
        // Sort by Nezha display index (the value inside ID(sort), descending), then by id for stable ordering
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="pt-4">
          {selectionMode === "multi" ? (
            <div className="max-h-50 overflow-y-auto sm:max-h-25">
