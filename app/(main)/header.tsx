    ...
    <div className="mx-auto w-full max-w-[1500px]">
      <section className="flex items-center justify-between">
        <button
          ...
          className="flex cursor-pointer items-center font-medium text-[21px] leading-none transition-opacity duration-300 hover:opacity-50"
        >
          <div className="mr-1 flex flex-row items-center justify-start">
            <img
              ...
              className="relative m-0! h-12 w-12 border-2 border-transparent object-cover object-top p-0! dark:hidden"
            />
            <img
              width={40}
              height={40}
              ...
              className="relative m-0! hidden h-12 w-12 border-2 border-transparent object-cover object-top p-0! dark:block"
            />
          </div>
          {customTitle ? customTitle : "NezhaDash"}
          <Separator orientation="vertical" className="mx-4 hidden h-8 w-px md:block" />
          <p className="hidden font-medium text-[14px] leading-none opacity-40 md:block">
